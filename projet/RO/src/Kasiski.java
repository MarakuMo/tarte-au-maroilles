...
public class Kasiski {
	...
	public static void main(String[] args) {
		...
		if (args.length != 2) {
			System.out
					.println(" Veuillez respecter le mod̬le : Kasiski <file-in> <file-ref>");
		} else {
			try {
				...
				boolean ok = false;
				while (!ok) {
					System.out.println("Longueur de Cl̩ propos̩e  :  " + n);
					System.out
					...
					while (!ok0) {
						...
						vigenere.main(arg2);
						System.out
								.println("Cette Cl̩ vous convient-elle ? <y> / <n>");
						boolean ok2 = false;
						while (!ok2) {
	...
	// 1 : Trouver la longueur n de la cl̩
	/*
	 * Ne pas d̩passer des tests de cl̩s de longueur 15. <=> 2 < m < 15
	 */
